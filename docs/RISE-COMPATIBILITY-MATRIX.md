...
| SCORM 1.2 package | **Unsupported** | No archive is produced. The "Prepare ZIP Asset Manifest" button only writes a manifest of assets that need to travel separately; it does not package a SCORM-conformant zip (`docs/KNOWN-ISSUES.md`). |
